  ...
  return (
    <div className="min-h-screen bg-[#100418] flex items-center justify-center p-5 font-['Jost']">
      <div className="card relative bg-white/5 border border-[#C9AA6D]/20 p-10 max-w-[480px] text-center shadow-[0_16px_40px_rgba(0,0,0,0.4)] animate-fadeUp">
        <div className="absolute top-0 left-0 right-0 h-[2px] bg-gradient-to-r from-[#380D57] via-[#C9AA6D] to-[#AD2D6C]"></div>
        ...
        <h1 className="font-['Playfair_Display'] text-[32px] text-[#F5EEFA] mb-4 font-medium leading-tight">
          Pagamento Confirmado!
        </h1>
        
        <p className="text-[#F5EEFA]/70 mb-6 text-[15px] leading-relaxed">
          Seja bem-vinda ao Despertar. Seu pagamento foi processado com sucesso e seu acesso já foi enviado para o seu e-mail.
        </p>
        
        <p className="text-[#F5EEFA]/70 mb-6 text-[15px] leading-relaxed">
          Prepare-se para transformar sua energia e dominar a arte da conquista.
        </p>
